...
COLOR_SCALE   = [[0, "#f43f5e"], [0.5, "#f59e0b"], [1, "#22c55e"]]
ACCENT_BLUE   = "#3b82f6"
...
with st.sidebar:
    ...
    <div style="padding:1.2rem 0 1rem;">
        <div style="font-size:1.25rem;font-weight:700;color:#f1f5f9;letter-spacing:-0.01em;">🛡️ HSE Dashboard</div>
        <div style="font-size:0.75rem;color:#475569;margin-top:0.2rem;">Hệ thống phân tích học sinh</div>
    </div>
    """, unsafe_allow_html=True)
...
# ─────────────────────────────────────────────
    ...
    with c3:
        color = "#f43f5e" if len(danger) > 0 else "#22c55e"
    ...
    fig.add_hline(y=50, line_dash="dot", line_color="#f43f5e",
